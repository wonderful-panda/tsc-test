    ...
    function Tester(compilerOptions, sources) {
        ...
        var host = {
            ...
            resolveModuleNames: function (moduleNames, containingFile) {
                var resolutionHost = { fileExists: ts.sys.fileExists, readFile: ts.sys.readFile };
                var ret = [];
                moduleNames.forEach(function (name) {
                    var resolved = ts.resolveModuleName(name, containingFile, compilerOptions, resolutionHost).resolvedModule;
